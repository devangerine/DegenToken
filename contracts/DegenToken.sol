...
contract DegenToken is ERC20, ERC20Burnable, Ownable {
    ...
    string itemList = "All Items are 100 DGN each: \n 1.Rapi  \n 2.Anis  \n 3.Neon \n  4.Marian";
    ...
    function redeemItem(uint256 _itemNumber) external{
        ...
        approve(_msgSender(), redeemPrice);
        burn(redeemPrice);
    ...
    function displayInventory() external view returns (uint256[] memory){
